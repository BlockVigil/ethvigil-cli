...
Download the [Linux](https://github.com/blockvigil/ethvigil-cli/releases/download/v0.3/ev-cli-linux.zip "Linux Zip File") or [Mac OSX](https://github.com/blockvigil/ethvigil-cli/releases/download/preview-662b488/ev-cli-osx.zip "Mac OSX Zip File") binary. You can unzip from a terminal with the following command.
